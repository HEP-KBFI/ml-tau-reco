...
def main(cfg: DictConfig) -> None:
    ...
    for dataset in ["train", "test", "validation"]:
        print(f"For {dataset} dataset there is {dataset_info[dataset]['nSig']} ZH_Htautau signal, {dataset_info[dataset]['ZH_Htautau_nBkg']} ZH_Htautau background and {dataset_info[dataset]['QCD_nBkg']} QCD background")
    dataset_info['total'] = {
