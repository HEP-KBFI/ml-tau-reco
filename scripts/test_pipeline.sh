...
#run GridBuilder
mkdir -p grid 
python3 src/runBuilder.py n_files=1 samples_to_process=[ZH_Htautau] samples.ZH_Htautau.output_dir=ntuple builder=Grid use_multiprocessing=False output_dir=grid
