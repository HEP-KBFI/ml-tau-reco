...
if [ ! -d "$INFILE_TAU_DIR" ]; then
    wget --directory-prefix ZH_Htautau -q --no-check-certificate -nc https://jpata.web.cern.ch/jpata/mlpf/clic_edm4hep_2023_02_21/reco_p8_ee_ZH_Htautau_ecm380_200001.root
...
if [ ! -d "$INFILE_QCD_DIR" ]; then
    wget --directory-prefix QCD -q --no-check-certificate -nc https://jpata.web.cern.ch/jpata/mlpf/clic_edm4hep_2023_02_21/reco_p8_ee_qq_ecm380_101340.root
    INFILE_QCD_DIR=$PWD/QCD
else
    mkdir -p root_input/p8_ee_qq_ecm380
    cp /local/joosep/clic_edm4hep_2023_02_21/p8_ee_qq_ecm380/reco_p8_ee_qq_ecm380_101340.root root_input/p8_ee_qq_ecm380/
...
QCD_FILENAME=reco_p8_ee_qq_ecm380_101340.parquet
...
validation:
  paths:
  - ./ntuple/reco_p8_ee_qq_ecm380_101340.parquet
EOF
